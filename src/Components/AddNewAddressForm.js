...
const AddNewAddressForm = () => {
  ...
  return (
    <ScrollView>
     <AddressTextField  keyboardType="default" title={t('first_name')} placeholder={t('peter_leung')}/>
     ...
     <AddressTextField  keyboardType="phone-pad" title={t('contact_no')} placeholder={t('phone_pad')} childern={<RightArrow/>}/>
